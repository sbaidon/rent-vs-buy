...
> = {
  US: {
    ...
    isNewBuild: { min: 0, max: 1, step: 1 },
    isFirstTimeBuyer: { min: 0, max: 1, step: 1 },
    isPrimaryResidence: { min: 0, max: 1, step: 1 },
    willReinvest: { min: 0, max: 1, step: 1 },
  },
  MX: {
  ...
  // Germany - EUR based, higher closing costs, longer terms
  DE: {
    homePrice: { min: 100000, max: 2000000, step: 10000 },
    monthlyRent: { min: 500, max: 5000, step: 50 },
    mortgageRate: { min: 0, max: 0.1, step: 0.001 },
    downPayment: { min: 0.1, max: 1, step: 0.01 },
    yearsToStay: { min: 1, max: 40, step: 1 },
    mortgageTerm: { min: 1, max: 30, step: 1 },
    pmi: { min: 0, max: 0.05, step: 0.001 },
    homePriceGrowth: { min: -0.05, max: 0.1, step: 0.001 },
    rentGrowth: { min: -0.05, max: 0.1, step: 0.01 },
    investmentReturn: { min: -0.2, max: 0.15, step: 0.01 },
    inflationRate: { min: -0.02, max: 0.08, step: 0.001 },
    propertyTaxRate: { min: 0, max: 0.02, step: 0.001 },
    marginalTaxRate: { min: 0, max: 0.45, step: 0.01 },
    otherDeductions: { min: 0, max: 50000, step: 1000 },
    buyingCosts: { min: 0, max: 0.15, step: 0.001 },
    sellingCosts: { min: 0, max: 0.08, step: 0.001 },
    maintenanceRate: { min: 0, max: 0.03, step: 0.001 },
    homeInsuranceRate: { min: 0, max: 0.01, step: 0.001 },
    extraPayments: { min: 0, max: 2000, step: 50 },
    securityDeposit: { min: 1, max: 3, step: 1 },
    brokerFee: { min: 0, max: 0.1, step: 0.01 },
    monthlyRentersInsurance: { min: 0, max: 100, step: 5 },
    isJointReturn: { min: 0, max: 1, step: 1 },
    taxCutsExpire: { min: 0, max: 1, step: 1 },
  ...
  // France - EUR based, high notary fees
  FR: {
    homePrice: { min: 100000, max: 2000000, step: 10000 },
    monthlyRent: { min: 500, max: 5000, step: 50 },
    mortgageRate: { min: 0, max: 0.1, step: 0.001 },
    downPayment: { min: 0.1, max: 1, step: 0.01 },
    yearsToStay: { min: 1, max: 40, step: 1 },
    mortgageTerm: { min: 1, max: 25, step: 1 },
    pmi: { min: 0, max: 0.05, step: 0.001 },
    homePriceGrowth: { min: -0.05, max: 0.1, step: 0.001 },
    rentGrowth: { min: -0.05, max: 0.1, step: 0.01 },
    investmentReturn: { min: -0.2, max: 0.15, step: 0.01 },
    ...
    marginalTaxRate: { min: 0, max: 0.45, step: 0.01 },
    otherDeductions: { min: 0, max: 50000, step: 1000 },
    buyingCosts: { min: 0, max: 0.12, step: 0.001 },
    sellingCosts: { min: 0, max: 0.08, step: 0.001 },
    maintenanceRate: { min: 0, max: 0.03, step: 0.001 },
    homeInsuranceRate: { min: 0, max: 0.01, step: 0.001 },
    extraPayments: { min: 0, max: 2000, step: 50 },
  ...
  // United Kingdom - GBP based, stamp duty
  GB: {
    homePrice: { min: 100000, max: 2000000, step: 10000 },
    monthlyRent: { min: 500, max: 8000, step: 50 },
    mortgageRate: { min: 0, max: 0.1, step: 0.001 },
    downPayment: { min: 0.05, max: 1, step: 0.01 },
    yearsToStay: { min: 1, max: 40, step: 1 },
    mortgageTerm: { min: 1, max: 35, step: 1 },
    pmi: { min: 0, max: 0.05, step: 0.001 },
    homePriceGrowth: { min: -0.05, max: 0.1, step: 0.001 },
    rentGrowth: { min: -0.05, max: 0.1, step: 0.01 },
    investmentReturn: { min: -0.2, max: 0.15, step: 0.01 },
    ...
    marginalTaxRate: { min: 0, max: 0.45, step: 0.01 },
    otherDeductions: { min: 0, max: 50000, step: 1000 },
    buyingCosts: { min: 0, max: 0.1, step: 0.001 },
    sellingCosts: { min: 0, max: 0.05, step: 0.001 },
    maintenanceRate: { min: 0, max: 0.03, step: 0.001 },
    homeInsuranceRate: { min: 0, max: 0.01, step: 0.001 },
    extraPayments: { min: 0, max: 2000, step: 50 },
    securityDeposit: { min: 1, max: 2, step: 1 },
    brokerFee: { min: 0, max: 0.05, step: 0.01 },
    monthlyRentersInsurance: { min: 0, max: 100, step: 5 },
    isJointReturn: { min: 0, max: 1, step: 1 },
    taxCutsExpire: { min: 0, max: 1, step: 1 },
    isNewBuild: { min: 0, max: 1, step: 1 },
  ...
  // Italy - EUR based
  IT: {
    homePrice: { min: 50000, max: 1500000, step: 10000 },
    monthlyRent: { min: 300, max: 4000, step: 50 },
    mortgageRate: { min: 0, max: 0.1, step: 0.001 },
    downPayment: { min: 0.1, max: 1, step: 0.01 },
    yearsToStay: { min: 1, max: 40, step: 1 },
    mortgageTerm: { min: 1, max: 30, step: 1 },
    ...
    homePriceGrowth: { min: -0.05, max: 0.1, step: 0.001 },
    rentGrowth: { min: -0.05, max: 0.1, step: 0.01 },
    investmentReturn: { min: -0.2, max: 0.12, step: 0.01 },
    inflationRate: { min: -0.02, max: 0.08, step: 0.001 },
    propertyTaxRate: { min: 0, max: 0.02, step: 0.001 },
    marginalTaxRate: { min: 0, max: 0.43, step: 0.01 },
    otherDeductions: { min: 0, max: 50000, step: 1000 },
    buyingCosts: { min: 0, max: 0.15, step: 0.001 },
    sellingCosts: { min: 0, max: 0.08, step: 0.001 },
    maintenanceRate: { min: 0, max: 0.03, step: 0.001 },
  ...
  ES: {
    ...
    inflationRate: { min: -0.02, max: 0.08, step: 0.001 },
    propertyTaxRate: { min: 0, max: 0.02, step: 0.001 },
    marginalTaxRate: { min: 0, max: 0.47, step: 0.01 },
    otherDeductions: { min: 0, max: 50000, step: 1000 },
    buyingCosts: { min: 0, max: 0.15, step: 0.001 },
    sellingCosts: { min: 0, max: 0.08, step: 0.001 },
    maintenanceRate: { min: 0, max: 0.03, step: 0.001 },
