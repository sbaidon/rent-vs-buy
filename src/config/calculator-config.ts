...
> = {
  US: {
    ...
    sellingCosts: { min: 0, max: 0.06, step: 0.001 },
  ...
  MX: {
    homePrice: { min: 500000, max: 20000000, step: 50000 },
    ...
    sellingCosts: { min: 0, max: 0.08, step: 0.001 },
  ...
  CA: {
    ...
    sellingCosts: { min: 0, max: 0.05, step: 0.001 },
    maintenanceRate: { min: 0, max: 0.02, step: 0.001 },
    homeInsuranceRate: { min: 0, max: 0.015, step: 0.001 },
