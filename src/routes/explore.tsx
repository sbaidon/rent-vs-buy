...
function ExploreHeader() {
  ...
  return (
    <header
      className="backdrop-blur-xl border-b px-3 sm:px-4 py-2 sm:py-2.5 z-20"
      style={{
    ...
    >
      <div className="max-w-7xl mx-auto flex items-center gap-2 sm:gap-3">
        ...
        <button
          ...
          className="relative shrink-0 h-[26px] px-2 rounded-md border text-[11px] font-medium uppercase tracking-wide transition-colors flex items-center gap-1"
          style={{
            borderColor: "var(--border-default)",
